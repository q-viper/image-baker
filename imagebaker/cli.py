...
def bake_simple(
    ...
    opacities: str | None = typer.Option(
        None, "--opacities",
...
def bake_from_config(
    ...
    output: Path | None = typer.Option(None, "-o", "--output", help="Output image path"),
):
    """
