...
class Layer:
    ...
    def __init__(self, image: QPixmap, name: str | None = None):
        """
        Initialize a Layer.
    ...
    @classmethod
    def from_file(cls, image_path: str | Path, name: str | None = None) -> "Layer":
        """
    ...
    @classmethod
    def from_array(cls, image: np.ndarray, name: str | None = None) -> "Layer":
        """
